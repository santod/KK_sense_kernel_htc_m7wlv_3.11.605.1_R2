...
#if defined (CONFIG_MACH_DUMMY) || defined (CONFIG_MACH_DUMMY) || defined(CONFIG_MACH_M7_WLV) || defined(CONFIG_MACH_DUMMY) || defined(CONFIG_MACH_DUMMY) || defined(CONFIG_MACH_DUMMY)
	INT_KEY_HP,
#endif
};
